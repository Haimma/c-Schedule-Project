...
//namespace Schedule
//{
//    public partial class Requests_Lecturers : Form
//    {
...
//        public Requests_Lecturers(string userName, string password)
//        {
//            InitializeComponent();
//            this.Show();
//            users_db = new UsersDB();
//            user = new User();
//            users_db.FindUser(userName, password, ref user);
...
//            lecturers_db.Get_Lecturer_Courses(this.comboBox1, id);
...
//        private void course_Lable(object sender, EventArgs e)
//        {

//        }

//        private void course_comboBox1(object sender, EventArgs e)
//        {

//        }

//        private void Add_Lecture_Button(object sender, EventArgs e)
//        {
//            panel1.Visible = true;
//            panel2.Visible = false;
//        }

//        private void Cancell_Lecture_Button(object sender, EventArgs e)
//        {
...
namespace Schedule
{
    public partial class Requests_Lecturers : Form
    {
        ...
        private void CancellLec_Final_Confirmation_Button(object sender, EventArgs e)
        {
            ...
            reqLectDB.Add_Request(user.Get_First_Name(), user.Get_Last_Name(), CANCELL, cbo_Courses.Text, day, hour, classroom);
            Panel_Lecturer_Requests_Main.Visible = true;
            cbo_Cancell_Day.Items.Clear();
            cbo_Cancell_Day.ResetText();
            cbo_Courses.ResetText();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    reqLec.Add_Request(user.Get_First_Name(), user.Get_Last_Name(), ADD_LEC, cbo_Courses.Text, LeteralDay, Convert.ToInt32(cbo_Hour.Text), free_classes[0]);
                }
